...
RLS_TABLES = [
    "applicants", "kyc_records", "employment_records", "business_records",
    "income_records", "expense_records", "asset_records", "liability_records",
    "existing_loans", "transaction_records", "financial_documents",
    "loan_products", "loan_applications", "loan_workflow_events", "loan_decisions",
    "risk_scores", "credit_scores", "default_predictions", "fraud_alerts",
