...
import ApplicantProfileEditor from "../components/ApplicantProfileEditor";
import ApplicantTransactions from "../components/ApplicantTransactions";
...
export default function ApplicantDetail() {
  ...
  return <div className="space-y-5">
    ...
    {can("applicant:manage") && id && <ApplicantProfileEditor applicantId={id} />}
    {id && <ApplicantTransactions applicantId={id} />}
